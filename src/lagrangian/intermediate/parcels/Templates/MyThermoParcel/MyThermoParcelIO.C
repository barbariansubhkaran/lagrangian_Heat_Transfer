...
Foam::string Foam::MyThermoParcel<ParcelType>::propertyList_ =
    Foam::MyThermoParcel<ParcelType>::propertyList();


template<class ParcelType>
const std::size_t Foam::MyThermoParcel<ParcelType>::sizeofFields
(
    sizeof(MyThermoParcel<ParcelType>)
  - offsetof(MyThermoParcel<ParcelType>, T_)
);
...
void Foam::MyThermoParcel<ParcelType>::readFields(CloudType& c)
{
    ...
    label i = 0;
    for (MyThermoParcel<ParcelType>& p : c)
    {
        p.T_ = T[i];
        p.Cp_ = Cp[i];
...
template<class ParcelType>
template<class CloudType>
void Foam::MyThermoParcel<ParcelType>::writeFields(const CloudType& c)
{
    ...
    label i = 0;
    for (const MyThermoParcel<ParcelType>& p : c)
    {
        T[i] = p.T_;
        Cp[i] = p.Cp_;
...
template<class ParcelType>
void Foam::MyThermoParcel<ParcelType>::writeProperties
(
    Ostream& os,
...
template<class ParcelType>
template<class CloudType>
void Foam::MyThermoParcel<ParcelType>::readObjects
(
    CloudType& c,
...
template<class ParcelType>
template<class CloudType>
void Foam::MyThermoParcel<ParcelType>::writeObjects
(
    const CloudType& c,
    objectRegistry& obr
)
...
)
{
    ...
    else
    {
        ...
        (
            ...
            MyThermoParcel<ParcelType>::sizeofFields
        );
    }
