...
)
{
    ...
    MyThermoParcel<KinematicParcel<particle>>::writeFields(c);
...
)
{
    //ParcelType::readObjects(c, obr);
    // Skip Reacting layer
    MyThermoParcel<KinematicParcel<particle>>::readObjects(c, obr);
...
)
{
    //ParcelType::writeObjects(c, obr);
    // Skip Reacting layer
    MyThermoParcel<KinematicParcel<particle>>::writeObjects(c, obr);
